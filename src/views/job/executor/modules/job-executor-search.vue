...
const model = defineModel<Api.Job.JobExecutorParams>('model', { required: true });
...
<template>
  <SearchForm btn-span="24 s:12 m:18 l:12 xl:18" :model="model" @search="search" @reset="reset">
