const local: App.I18n.Schema = {
 ...
 <br />
    ...
    retry: {
      ...
      editRetry: '编辑重试',
      batchAddRetry: '批量新增',
      batchUpdateTip: '此操作将会通过搜索条件更新数据到指定状态！',
      searchConditions: '搜索条件',
      estimatedUpdateData: '预计更新数据量',
      noSearchConditionsTip: '请先设置搜索条件后再进行批量更新！',
      retryStatusRequiredTip: '状态搜索条件是批量更新的必选项，请先设置状态搜索条件！',
      groupNameRequiredTip: '组名称是批量更新的必选项，请先设置组名称！',
      sceneNameRequiredTip: '场景名称是批量更新的必选项，请先设置场景名称！',
      batchUpdateRequiredFieldsTip: '批量更新需要以下必填项，请先设置：',
      statusSameTip: '搜索条件中的状态与选择的新状态一致，无需更新！',
      totalZeroTip: '待更新数据量为0，无需更新！',
      batchUpdateSuccess: '批量更新成功，共更新 ',
      records: ' 条数据！',
      batchUpdateToRetryingTipPrefix: '更新任务已提交，耐心等待更新结果！',
      batchUpdateToRetryingTipSuffix: '分钟内请勿重复提交相同任务！',
